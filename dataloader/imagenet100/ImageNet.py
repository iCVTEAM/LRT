...
class ImageNet(Dataset):
    ...
    def __init__(self, root='/media/data/zyf/imagenet/', train=True,
                 transform=None,
        ...
        # modified this with your own path
        self.SPLIT_PATH = '/media/data/zyf/code/sourcecode/data/index_list/imagenet100/'
        # modified this with your own path

        self.LABEL_TEXT = os.path.join('./data/index_list/imagenet100/label_text.txt')
        labeltext_dict = self.LoadLabelText(self.LABEL_TEXT)
        ...
        self.wnids = []
        self.text_dict ={} ################# check this zyf/code/sourcecode/data/index_list/imagenet100/

        for l in lines:
            name, wnid = l.split(',')  # note this
            path = osp.join(self.IMAGE_PATH, name)
            if wnid not in self.wnids:
                self.wnids.append(wnid)
                lb += 1
                self.text_dict[str(lb)] = labeltext_dict[wnid]################# check this 
                #print(lb)
                #print(labeltext_dict[wnid])
                #print(wnid)
    ...
    def LoadLabelText(self,index_path):
        labeltext_dict = {}
        ...
        for line in lines:
            ...
            text = line.split(' ')[2:]
            #text_new = ' '.join(text)
            labeltext_dict[index]=text
            
        return labeltext_dict
...
if __name__ == '__main__':
    ...
    dataroot = '/media/data/zyf/imagenet/'
    batch_size_base = 400
