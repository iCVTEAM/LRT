...
class MiniImageNet(Dataset):
    ...
    def __init__(self, root='./data', train=True,
        ...
        #/home/yfzhao/FSL/clip-fewshot/data/index_list/mini_imagenet/
        self.LABEL_TEXT = os.path.join('./data/index_list/mini_imagenet/label_text.txt')
